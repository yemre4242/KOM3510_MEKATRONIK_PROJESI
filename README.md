# KOM3510_MEKATRONIK_PROJESI
KOM3510 kodlu mekatronik projesi için yapmış olduğumuz araç tanıma ve akıllı otopark yönetim sistemi
...
Kod öncelik olarak .engine dosyasını arar eğer bu dosya mevcut değilse .pt dosyası kullanılır. .engine dosyası kullanmak sistemin daha hızlı dolayısıyla görüntülerin daha çok fps ile alınmasını sağlar.Bu da okunan görüntü sayısını arttırarak tespitlerin doğruluğunu arttırır.
